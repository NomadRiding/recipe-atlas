...
render() {
    return (
        <div>
            <Carousel>
                <Carousel.Item>
                    <img width={900} height={500} alt="Pasta allo scarpariello" src="https://www.giallozafferano.it/images/ricette/198/19843/foto_hd/hd650x433_wm.jpg" />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Italian Chicken Alfredo" src="https://images-gmi-pmc.edge-generalmills.com/5b31acd1-946b-4eb1-bb5c-b9141056178f.jpg" />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Creamy Tuscan Sausage Pasta" src="https://res.cloudinary.com/hellofresh/image/upload/f_auto,fl_lossy,q_auto/v1/hellofresh_s3/image/tuscan-sausage-and-pepper-spaghetti-743e2dd9.jpg" />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Marguerita Pizza" src="https://assets.marthastewart.com/styles/wmax-1500/d31/pizza-margherita-0606-mla102155/pizza-margherita-0606-mla102155_sq.jpg?itok=3FuCCotM" />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Pizza Arrotolata" src="https://www.giallozafferano.it/images/ricette/36/3601/foto_hd/hd450x300.jpg" />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Pizza Fritta" src="http://www.ricettapizzanapoletana.it/images/pizza_fritta_napoletana.jpg" />
                    <Carousel.Caption>
                        <h3>Pizza Fritta</h3>
                ...
                <Carousel.Item>
                    <img width={900} height={500} alt="Tiramisu" src="https://cocineroaficionado.com/wp-content/uploads/2015/09/tiraminu-s.jpg" />
                    <Carousel.Caption>
                        <h3>Tiramisu</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img width={900} height={500} alt="Chocolate Amaretti Cake" src="https://teaandtakes.files.wordpress.com/2015/03/almond-chocolate-amaretto-cake.jpg?w=529&h=353" />
                    <Carousel.Caption>
                        <h3>Chocolate Amaretti Cake</h3>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                    <img width={900} height={500} alt="Lemon Ricotta Cake" src="https://cmt.azureedge.net/media/orig_lemon_ricotta_cake_with_candied_lemons_20170403134855560196absb4.jpg" />
                    <Carousel.Caption>
...
// import React from 'react';
// import { Carousel, Image, Icon } from 'react-bootstrap';
//
// class Carousel extends React.Component {
//
//   render() {
